this.unhold_fur_upgrade_purple <- this.inherit("scripts/items/armor_upgrades/unhold_fur_upgrade", {
	m = {},
	function create()
	{
		this.unhold_fur_upgrade.create();
		this.m.Name = "Purple " + this.m.Name;
		this.m.ID = "armor_upgrade.unhold_fur_purple";
